...
import { parseFilterValue } from 'src/app/shared/helpers/filter';
...
export class PageCategoryComponent implements OnDestroy {
    ...
    constructor(
        ...
        this.route.data.subscribe(data => {
            console.log('PageCategoryComponent this.route.data -> %O', data);
            this.breadcrumbs = [
                {label: 'Home', url: this.root.home()},
                {label: 'Shop', url: this.root.shop()},
            ];

            console.log('PageCategoryComponent this.breadcrumbs -> %O', this.breadcrumbs);
            ...
            console.log('PageCategoryComponent this.route.data 2 -> %O', data);

            console.log('PageCategoryComponent data.products -> %O', data.products);
