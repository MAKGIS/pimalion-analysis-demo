...
export const mobileMenuStroyka: MobileMenuItem[] = [
        ...
        {type: 'link', label: 'Categories', url: '/pimalion/categories'},
        {type: 'link', label: 'Brands', url: '/pimalion/brands'},
        {type: 'link', label: 'Categories Grid', url: '/categories-grid'},
        {type: 'link', label: 'Pimalion Grid', url: '/pimalion/catalog'},
    ]},
