...
export const navigationStroyka: NavigationLink[] = [
    {label: 'Home', url: '/', menu: {
        type: 'menu',
        items: [
            {label: 'Home 1', url: '/'},
            ...
            {label: 'Categories', url: '/pimalion/categories'},
            {label: 'Brands', url: '/pimalion/brands'},
            {label: 'Categories Grid', url: '/categories-grid'},
            {label: 'Pimalion Grid', url: '/pimalion/catalog'},
        ]
    }},
